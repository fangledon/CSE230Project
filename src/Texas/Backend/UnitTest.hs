...
unitTestEx2 = do
                ...
                tu4 <- tryDoAction tu3 (alice tu3) $ DoAdd 90
                ...
                tu5 <- tryDoAction tu4 (betty tu4) $ DoAdd 390
                ...
                tu6 <- tryDoAction tu5 (alice tu5) DoFold
...
unitTestEx1 = do
                ...
                flop2 <- tryDoAction flop1 (bob flop1) DoPass
                ...
                flop3 <- tryDoAction flop2 (carol flop2) (DoAdd 2)
                ...
                flop6 <- tryDoAction flop5 (carol flop5) $ DoAdd 2
                ...
                turn2 <- tryDoAction turn1 (bob turn1) DoPass
                ...
                turn3 <- tryDoAction turn2 (carol turn2) DoPass
                ...
                turn4 <- tryDoAction turn3 (alice turn3) DoPass
                ...
                river2 <- tryDoAction river1 (bob river1) $ DoAdd 4
                ...
                river3 <- tryDoAction river2 (carol river2) $ DoAdd 4
                ...
                river4 <- tryDoAction river3 (alice river3) DoFold
